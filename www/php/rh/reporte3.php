<?php
  ...
  $consulta="SELECT c.fecha,e.idempleados, CONCAT_WS(' ',e.nombre,e.apellidos) as Nombre, SUM(((TIME_TO_SEC(SUBTIME(c.hora_final,c.hora_inicio)))/60)/60) - (c.tiempo_muerto/60) as tT,nm.num_parte
